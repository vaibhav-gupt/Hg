...
## Booklet
pdfnup --no-landscape --nup 1x1 --outfile part0.pdf -- ../../Hauptdokument/ews-cover-2a5.pdf 2
...
pdfnup --no-landscape --nup 1x1 --outfile part3.pdf -- ../../Hauptdokument/ews-cover-2a5.pdf 1
...
pdfjoin --no-landscape  --rotateoversize 'false' ../../Hauptdokument/ews-cover-2a5.pdf 2 ../../Hauptdokument/1w6-regeln-2.6.1i.pdf 2-48 ../../Hauptdokument/ews-cover-2a5.pdf 1 ../../releases/charheft-vobsy.pdf 1-4 --outfile 1w6-regeln-2.6.1i.pdf
pdfjoin --no-landscape  --rotateoversize 'false' ../../Hauptdokument/ews-cover-2a5.pdf 2 ../../Hauptdokument/1w6-regeln-2.6.1i.pdf 2-48 ../../Hauptdokument/ews-cover-2a5.pdf 1 ../GPLv3-4-seiten.pdf 1-4 ../../releases/charheft-vobsy.pdf 1-4 --outfile 1w6-regeln-2.6.1i-mit-lizenz.pdf
