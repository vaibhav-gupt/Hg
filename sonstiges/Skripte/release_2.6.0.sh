...
pdfnup --no-landscape --nup 1x1 --outfile part1.pdf --  ../../releases/1w6-regeln-2.6.0.pdf  1-24
 pdfnup --no-landscape --nup 1x1 --outfile part2.pdf -- ../../releases/1w6-regeln-2.6.0.pdf 25-48
 ...
 pdfjoin part1.pdf gpl-1.pdf charheft.pdf gpl-2.pdf part2.pdf --outfile test.pdf
